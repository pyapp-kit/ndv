...
class ViewerController:
    ...
    def __init__(
        self, data_model: ArrayDisplayModel | ArrayDataDisplayModel | None = None
    ) -> None:
        ...
        if isinstance(data_model, ArrayDisplayModel):
            data_model = ArrayDataDisplayModel(display=data_model)
        self._model: ArrayDataDisplayModel = data_model or ArrayDataDisplayModel()
    ...
    def display_model(self, display_model: ArrayDisplayModel) -> None:
        """Set the display model for the viewer."""
        self._set_model_connected(self._model.display, False)
        self._model.display = display_model
    ...
    def _fully_synchronize_view(self) -> None:
        ...
        if self.data is not None:
            ...
            self._view.set_current_index(self.display_model.current_index)
